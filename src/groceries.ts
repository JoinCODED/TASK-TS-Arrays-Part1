...
function createGroceries(): string[] {
  ...
  return ['Coffee','More Coffee','Even More Coffee','Alitte Bit More Coffee','Water Flavored Coffee','Apple']; // replace empty array with what you see is fit
}
