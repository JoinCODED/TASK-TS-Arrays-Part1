...
function createGroceries(): string[] {
  ...
  return ['Apples', 'Oranges', 'Diapers', 'Baby food', 'Tissue', 'Biscuits']; // replace empty array with what you see is fit
}
...
function removeLastGroceryItem(groceries: string[]): string {
  ...
  return lastItem?lastItem:""; // replace empty string with what you see is fit
}
